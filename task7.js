...
Task7.prototype.render = function(gl, w, h) {
    ...
    var view =
        Matrix.translate(0, 0, -5 + 3* Math.sin(Date.now()/10000)).multiply(
    ...
    var sphere1 = Matrix.scale(1.5, 1.5, 1.5).multiply(Matrix.translate(0, 0, 0).multiply(rotation));
    var sphere2 = Matrix.scale(0.9, 0.9, 0.9).multiply(Matrix.translate(r * Math.cos(pi/3.0), 0, r* Math.sin(pi/3,0)).multiply(rotation));
    var sphere3 = Matrix.scale(0.9, 0.9, 0.9).multiply(Matrix.translate(r * Math.cos(2.0 *pi/3.0), 0, r* Math.sin(2.0*pi/3.0)).multiply(rotation));
    var sphere4 = Matrix.scale(0.9, 0.9, 0.9).multiply(Matrix.translate(r * Math.cos(3.0*pi/3.0), 0, r* Math.sin(3.0*pi/3.0)).multiply(rotation));
    var sphere5 = Matrix.scale(0.9, 0.9, 0.9).multiply(Matrix.translate(r * Math.cos(4.0*pi/3.0), 0, r* Math.sin(4.0*pi/3.0)).multiply(rotation));
    var sphere6 = Matrix.scale(0.9, 0.9, 0.9).multiply(Matrix.translate(r * Math.cos(5.0*pi/3.0), 0, r* Math.sin(5.0*pi/3.0)).multiply(rotation));
